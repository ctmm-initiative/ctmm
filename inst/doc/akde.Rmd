...
With this code we will highlight Pepper's collar malfunction, where the sampling interval abruptly changed from (roughly) 1-hour to 2-hours per fix.
...
We calculate UDs with and with out accounting for autocorrelation (`M.OUF` versus `M.IID`), with and without optimal weighting of the data (`weights=TRUE`).
